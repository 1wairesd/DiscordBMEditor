...
/* Удаляю стили properties-sidebar и sidebar-*, добавляю стили для плавающей панели */
.floating-panel {
  position: absolute;
  top: 0;
  left: 0;
  ...
  display: flex;
  flex-direction: column;
  transform: translate(-50%, -50%); /* Центрируем по выбранному блоку */
  pointer-events: none; /* Отключаем взаимодействие с панелью */
}

.floating-panel.active {
  pointer-events: auto; /* Включаем взаимодействие при активности */
}
